...
const Navbar = () => {
    ...
    return (
        <>
            <div >
                <div className='w-full fixed max-w-360 mx-auto top-0 z-30  bg-white '>
                    <div className='max-w-285 mx-auto flex my-2.5 justify-between max-[1174px]:px-4 py-2 min-[1175px]:py-0' >
                    ...
                    <div className='w-full max-360 mx-auto  z-30 bg-[#01C6B5] h-auto md:h-17.5 max-[1174px]:px-4 py-2 min-[1175px]:py-0'>
                    <div className='max-w-285 mx-auto flex flex-row justify-between items-center h-auto sm:h-17.5  z-30'>
                        <Link to={"/"}>
            ...
            <div
                className={`fixed top-0 right-0 h-screen w-64 bg-[#009B8F] md:hidden z-40 flex flex-col gap-4 px-4 py-8 transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
                style={{
